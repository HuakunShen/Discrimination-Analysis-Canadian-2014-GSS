...
# Data
We started our analysis by using R [@citeR], dplyr[@dplyr], tidyverse[@tidyverse], here[@here]. Graphs are generated using and ggplot2[@ggplot2].
...
```{r, include=FALSE}
  ...
  mutate( Discrimination_Reason =
           case_when(Sex == 1 ~ "Sex",
                     Ethnicity_or_Culture == 1 ~ "Ethnicity or Culture",
                     Race_or_Skin_Colour == 1 ~ "Race or Skin Colour",
                     Physical_Appearance == 1 ~ "Physical Appearanc",
                     Religion == 1 ~ "Religion",
                     Sexual_Orientation == 1 ~ "Sexual Orientation",
                     Age == 1 ~ "Age",
                     Physical_or_Mental_Disability == 1 ~ "Physical or Mental Disability",
                     Language == 1 ~ "Language",
                     Other_Discrimination == 1 ~ "Other Discrimination Reason"
                     )) %>%
