...
```{r sex-crime-plot, fig.height=4, fig.cap="Sex Discrimination VS Crime", echo=FALSE, warning=FALSE, message = FALSE}
sex_crime_plot
```

```{r culture-crime-plot, fig.height=4, fig.cap="Ethnicity or culture Discrimination VS Crime", echo=FALSE, warning=FALSE, message = FALSE}
culture_crime_plot
```

```{r race-skin-crime-plot, fig.height=4, fig.cap="Race and Skin Color Discrimination VS Crime", echo=FALSE, warning=FALSE, message = FALSE}
race_skin_crime_plot
```

```{r physical-appearance-crime-plot, fig.height=4, fig.cap="Physical appearance Discrimination VS Crime", echo=FALSE, warning=FALSE, message = FALSE}
physical_appearance_crime_plot
```

```{r religion-crime-plot, fig.height=4, fig.cap="Religion Discrimination VS Crime", echo=FALSE, warning=FALSE, message = FALSE}
religion_crime_plot
```

```{r sexual-orientation-crime-plot, fig.height=4, fig.cap="Sexual orientation Discrimination VS Crime", echo=FALSE, warning=FALSE, message = FALSE}
sexual_orientation_crime_plot
```

```{r age-crime-plot, fig.height=4, fig.cap="Age Discrimination VS Crime", echo=FALSE, warning=FALSE, message = FALSE}
age_crime_plot
```

```{r physical-mental-disability-crime-plot, fig.height=4, fig.cap="Physical or mental disability Discrimination VS Crime", echo=FALSE, warning=FALSE, message = FALSE}
physical_mental_disability_crime_plot
```

```{r language-crime-plot, fig.height=4, fig.cap="Language Discrimination VS Crime", echo=FALSE, warning=FALSE, message = FALSE}
language_crime_plot
```

```{r university-education-vs-crime, fig.cap="University Education VS Crime", fig.width=8, fig.height=5, echo=FALSE, warning=FALSE, message = FALSE}
