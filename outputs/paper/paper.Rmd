...
```{r crime-plot, echo=FALSE, warning=FALSE, message = FALSE, fig.height=6, fig.width=8}
...
subset_data %>% 
  ...
  theme(axis.text.x = element_text(angle = 60, hjust = 1)) + xlab("Crime") +
  labs(title = "Crime Count", fill="Crime Category")
```

```{r crime-count-plot-by-education, echo=FALSE, warning=FALSE, message = FALSE, fig.height=6, fig.width=8}
...
```{r sex_crime_plot, echo=FALSE, warning=FALSE, message = FALSE}
sex_crime_plot
```

```{r culture_crime_plot, echo=FALSE, warning=FALSE, message = FALSE}
culture_crime_plot
```

```{r race_skin_crime_plot, echo=FALSE, warning=FALSE, message = FALSE}
race_skin_crime_plot
```

```{r physical_appearance_crime_plot, echo=FALSE, warning=FALSE, message = FALSE}
physical_appearance_crime_plot
```

```{r religion_crime_plot, echo=FALSE, warning=FALSE, message = FALSE}
religion_crime_plot
```

```{r sexual_orientation_crime_plot, echo=FALSE, warning=FALSE, message = FALSE}
sexual_orientation_crime_plot
```

```{r age_crime_plot, echo=FALSE, warning=FALSE, message = FALSE}
age_crime_plot
```

```{r physical_mental_disability_crime_plot, echo=FALSE, warning=FALSE, message = FALSE}
physical_mental_disability_crime_plot
```

```{r language_crime_plot, echo=FALSE, warning=FALSE, message = FALSE}
language_crime_plot
```
...
cross_compare_barplot(data=gss_data,
                      ...
                      plot_fill_lab="University Education")
```


```{r fig.width=8, fig.height=5, echo=FALSE, warning=FALSE, message = FALSE}
cross_compare_barplot(data=gss_data %>% filter(msvic < 900) %>% filter(eor_01b < 3),
                      col1 = "eor_01b", col2 = "msvic",
                      col1_num=eor_01b_num, col1_labels=eor_01b_label,
                      col2_num=msvic_num, col2_labels=msvic_labels, 
                      plot_title="College Education VS Crime",
                      plot_subtitle="",
                      plot_xlab="Crime", 
                      plot_ylab="Percentage", 
                      plot_fill_lab="college Education")
```

```{r fig.width=8, fig.height=5, echo=FALSE, warning=FALSE, message = FALSE}
cross_compare_barplot(data=gss_data %>% filter(msvic < 900) %>% filter(eor_01a < 3),
                      col1 = "eor_01a", col2 = "msvic",
                      col1_num=eor_01a_num, col1_labels=eor_01a_label,
                      col2_num=msvic_num, col2_labels=msvic_labels, 
                      plot_title="Elementary School Education VS Crime",
                      plot_subtitle="",
                      plot_xlab="Crime", 
                      plot_ylab="Percentage",
                      plot_fill_lab="Elementary School Education")
```
