...
I plotted the relationships between all discrimination types and crime categories from Figure \@ref(fig:sex_crime_plot) to Figure \@ref(fig:language_crime_plot).
